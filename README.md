...
1. Compare Waterfall vs. Agile (Scrum) for this launch using the criteria below: Adaptability & Time-to-Market Regulatory & Compliance Risk Handling
...
3. Gap Analysis: Identify where the communication and process breakdown occurred between Dev and Ops.
